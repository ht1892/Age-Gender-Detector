...
model = load_model('Age_Sex_Detection.model.keras')
...
#Defining the detect function that detects the age and gender of the person using the model
def Detect(file_path):
    ...
    label1.configure(foreground="#011038",text=age)
...
def upload_image():
    try:
        ...
        n=ImageTk.PhotoImage(uploaded)
        
        sign_image.configure(image=n)
        sign_image.image=n
